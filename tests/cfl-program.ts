  ...
  it("Squad Created! by Deployer", async () => {
    ...
    const ix = await program.methods
      ...
      .accounts({
        ...
        mplTokenMetadataProgram: "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s",
      })
      .instruction();
    ...
    await sendAndConfirmTransaction(connection, tx, [mint, keypairDeployer], {
      skipPreflight: false,
    });
